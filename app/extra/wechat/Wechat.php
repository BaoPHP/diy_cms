...
use wechat\base\ErrCode;
use wechat\src\Card;
use wechat\src\Custom;
use wechat\src\Device;
use wechat\src\Extend;
use wechat\src\Hardware;
use wechat\src\Media;
use wechat\src\Menu;
use wechat\src\Message;
use wechat\src\Oauth;
use wechat\src\Poi;
use wechat\src\Receive;
use wechat\src\Script;
use wechat\src\User;
use wechat\support\Exception;
